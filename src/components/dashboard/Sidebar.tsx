  ...
  return (
    <>
      ...
      >
        ...
        {/* Brand Header */}
        <div className="py-4.75 px-8 flex items-center bg-white z-10 justify-between border-b shadow-sm border-slate-100">
          <Link href="/" className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-rose-500 font-bold tracking-wider uppercase -mt-0.5">
                  {roleName}
                </span>
              </div>
            )}
          ...
          <button
            ...
            className="md:hidden text-slate-400 hover:text-slate-700 p-1.5 hover:bg-slate-100 rounded-lg transition-colors"
          >
            <Menu size={18} />
          </button>
        </div>
        ...
        {role === "client" && !collapsed && (
          <div className="bg-white/80 backdrop-blur-md border border-slate-100 p-4 rounded-3xl shadow-sm mb-4 mx-4">
            ...
            <h4 className="text-xs font-bold text-slate-800 text-center mt-2">
              Refer & Earn
            </h4>
