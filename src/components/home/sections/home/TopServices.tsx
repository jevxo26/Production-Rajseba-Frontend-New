      ...
      icon: (
        ...
        >
          <path
            ...
            d="M12 3v1m0 16v1M4.22 4.22l.7.7m13.16 13.16.7.7M3 12h1m16 0h1M4.22 19.78l.7-.7M19.08 4.92l-.7.7M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M7 3.34A10 10 0 0 0 2 12c0 2.21.72 4.26 1.93 5.93"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M17 3.34A10 10 0 0 1 22 12c0 2.21-.72 4.26-1.93 5.93"
          />
        </svg>
      ),
      slug: "ac-repair",
        ...
        >
          {SERVICES_CONTENT.services.map((service, i) => (
            ...
            >
              ...
              <div
                className={`relative h-48 md:h-52 ${service.bgColor} flex items-center justify-center overflow-hidden`}
              >
                {/* Subtle decorative ring behind icon */}
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div
                    className={`w-32 h-32 rounded-full opacity-10 ${service.bgColor.replace("50", "200")} border-[12px] border-current ${service.iconColor}`}
                  />
                </div>

                {/* Icon */}
                <div
                  className={`relative z-10 ${service.iconColor} drop-shadow-sm group-hover:scale-110 transition-transform duration-300`}
                >
                  {service.icon}
                </div>
