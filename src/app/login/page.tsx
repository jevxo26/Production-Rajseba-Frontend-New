...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Star, Briefcase, ShieldCheck } from "lucide-react"
          ...
          <div className="w-full max-w-[420px] mx-auto py-10 relative z-10">
            <div className="space-y-2 mb-8">
              ...
              <p className="text-sm text-slate-500 font-medium leading-relaxed">
                Access your premium home services dashboard.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-655 focus:outline-none"
                  >
              ...
              <div className="flex justify-between items-center text-xs md:text-sm pt-1 select-none">
                ...
                <Link href="/forgot-password" className="text-[#FF565C] font-bold hover:underline">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#FF565C] hover:bg-[#FF464C] text-white text-sm font-bold py-3.5 rounded-[14px] shadow-sm shadow-[#FF565C]/10 transition-all flex items-center justify-center gap-2 focus:outline-none mt-2"
              >
                Login to Account
                <ArrowRight size={18} />
              </button>
