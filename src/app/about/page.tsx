  ...
  return (
    <div className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section
          ref={heroRef}
          className="relative border-b border-slate-100 py-10 md:py-14 lg:py-16 overflow-hidden"
        >
          {/* Parallax glow */}
          <motion.div
            style={{ y: glowY }}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              >
                ...
                >
                  Rajseba was born out of a simple need: to bring safety,
                  reliability, and top-tier professionalism to the home services
                  industry in Bangladesh. We connect premium homes with
                  background-verified expert professionals for seamless care.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 32 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        {/* ══ STATS ════════════════════════════════════════════════ */}
        <section className="bg-primary/10 border-b border-slate-100 shadow-lg py-10 md:py-14 lg:py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              <Reveal variants={fadeLeft}>
                <motion.div
                  whileHover={{
                    y: -4,
                    boxShadow: "0 16px 40px rgba(255,90,95,0.08)",
                  }}
                ...
                >
                  ...
                  <h2 className="text-lg md:text-2xl font-bold text-foreground tracking-wide">
                    Our Mission
                  </h2>
                  <p className="text-slate-500 text-sm md:text-base leading-relaxed">
                    To build Bangladesh's most reliable and secure ecosystem for
                    on-demand home services, empowering local professionals with
                    job dignity while delivering standard-setting logistics
                    convenience to premium urban households.
                  </p>
                </motion.div>
              </Reveal>
              ...
              <Reveal variants={fadeRight}>
                ...
                >
                  ...
                  <p className="text-slate-500 text-sm md:text-base leading-relaxed">
                    To become the ultimate household companion in South Asia,
                    synonymous with absolute quality, trusted integrity, and
                    visual excellence, transforming the way services are booked,
                    verified, and valued in society.
                  </p>
                </motion.div>
              </Reveal>
            </div>
        ...
        {/* ══ CORE VALUES ══════════════════════════════════════════ */}
        <section className="border-y border-slate-100 py-10 md:py-14 lg:py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <Reveal
              variants={stagger}
            ...
            >
              <motion.h2
                ...
                className="text-lg md:text-2xl font-bold text-foreground mb-3 tracking-wide"
              >
              ...
              >
                Our culture is built on values that guarantee the safety and
                comfort of your household.
              </motion.p>
            </Reveal>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            ...
            >
              ...
              <motion.h2
                ...
                transition={{ duration: 0.55, ease: "easeOut", delay: 0.07 }}
                viewport={{ once: true, margin: "-70px" }}
                className="text-lg md:text-2xl font-bold text-foreground mt-3 mb-3 tracking-wide"
              >
              ...
              >
                Our leaders bring together technology, hospitality, and rigorous
