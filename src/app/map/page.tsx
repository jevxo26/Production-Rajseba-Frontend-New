  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans">
      <div className="flex-1 flex flex-col relative">
        ...
        {/* ==================== MAP TAB VIEW ==================== */}
        {activeTab === "map" && (
          <div className="max-w-7xl mx-auto px-4 md:px-6 w-full flex-1 min-h-0 flex flex-col md:flex-row gap-6 py-6 h-[calc(100vh-110px)] max-h-[707px] overflow-hidden relative">
            <SidebarList
