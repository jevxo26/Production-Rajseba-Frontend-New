    ...
    <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-100 hover:border-[#FF6014]/15 hover:shadow-lg hover:shadow-[#FF6014]/5 transition-all duration-300 p-6 flex flex-col justify-between">
              ...
              topVendors.map((vendor: any, idx: number) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-extrabold text-slate-800 truncate group-hover/v:text-[#FF6014] transition-colors">
                      {vendor.company_name}
                    </p>
      ...
      <div className="mt-5 pt-3 border-t border-slate-100">
        <Link
          ...
          className="w-full py-2.5 bg-slate-50 hover:bg-[#FF6014] hover:text-white rounded-2xl border border-slate-100 hover:border-[#FF6014] transition-all text-xs font-bold text-slate-600 flex items-center justify-center gap-1 shadow-2xs"
        >
