    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
      <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
        ...
        <div className="relative">
          ...
          />
          <button className="absolute bottom-0 right-0 p-1.5 bg-[#FF6014] hover:bg-[#E0530A] text-white rounded-full border-2 border-white shadow-md transition-transform active:scale-90">
