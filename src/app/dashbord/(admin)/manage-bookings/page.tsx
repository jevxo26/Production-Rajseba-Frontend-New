    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        <div className="flex items-center gap-3.5">
          <div className="p-3 bg-[#FFF8F4] text-[#FF6014] rounded-2xl border border-[#FF6014]/20 shadow-sm">
            <Calendar className="w-6 h-6" />
          </div>
          <div>
            <h1 className="text-xl font-extrabold text-slate-900 tracking-tight">{t.title}</h1>
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="bg-[#FF6014] hover:bg-[#E0530A] text-white font-extrabold px-5 py-2.5 rounded-xl text-sm transition-all shadow-md active:scale-[0.98] flex items-center gap-2"
          >
            <Calendar size={18} />
            {t.createBooking}
          </Link>
