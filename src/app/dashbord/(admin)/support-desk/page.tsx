    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#FF6014] hover:bg-[#E0530A] text-white font-extrabold px-5 py-2.5 rounded-xl text-sm transition-all shadow-md active:scale-95 cursor-pointer"
        >
          <RefreshCw size={16} />
          <span>{lang === "bn" ? "রিলোড করুন" : "Sync Tickets"}</span>
        </button>
      </div>
