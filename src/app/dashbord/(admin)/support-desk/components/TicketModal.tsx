        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wide">
              {lang === "bn" ? "বিষয়বস্তু" : "Ticket Subject"} <span className="text-[#FF6014]">*</span>
            </label>
            <input
              type="text"
              value={form.subject}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-3 py-2.5 text-sm font-semibold text-slate-800 outline-none focus:border-[#FF6014] transition-all"
              >
                {categories.map((c) => (
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wide">
              {lang === "bn" ? "বিস্তারিত বিবরণ" : "Description"} <span className="text-[#FF6014]">*</span>
            </label>
            <textarea
              rows={4}
