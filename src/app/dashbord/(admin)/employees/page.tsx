                ...
                <div className="space-y-1">
                  ...
                  {user.status !== "blocked" && (
                    <button
                      ...
                      className="w-full text-left px-3 py-2.5 text-xs text-[#E5675D] hover:bg-[#FFF8F7] flex items-center gap-2.5 font-semibold rounded-xl transition-all cursor-pointer"
                    >
