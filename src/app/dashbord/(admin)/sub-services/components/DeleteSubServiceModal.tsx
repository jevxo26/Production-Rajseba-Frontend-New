...
interface DeleteSubServiceModalProps {
  isDeleteModalOpen: boolean;
  setIsDeleteModalOpen: (val: boolean) => void;
  itemToDelete: SubService | null;
  setItemToDelete: (val: SubService | null) => void;
  handleDelete: () => void;
}

export default function DeleteSubServiceModal({
  isDeleteModalOpen,
  setIsDeleteModalOpen,
  itemToDelete,
  setItemToDelete,
  handleDelete,
}: DeleteSubServiceModalProps) {
