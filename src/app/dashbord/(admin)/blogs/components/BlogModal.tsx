        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-[#FF6014]/30 focus:ring-4 focus:ring-[#FFF8F4] transition-all"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-[#FF6014]/30 focus:ring-4 focus:ring-[#FFF8F4] transition-all resize-none"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            {/* Upload Box */}
            {images.length < 3 && (
              <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#FF6014]/30 rounded-2xl p-6 transition-all bg-slate-50/50 hover:bg-white text-center flex flex-col items-center justify-center cursor-pointer">
                <input
                  type="file"
                  accept="image/*"
                ...
                {isUploadingImage ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="p-3 bg-[#FFF8F4] text-[#FF6014] rounded-2xl group-hover:scale-105 transition-transform duration-250">
                      <Upload size={20} />
                    </div>
                    <div>
          ...
          <div className="border-t border-slate-100 pt-5 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-5 py-2.5 bg-[#FF6014] hover:bg-[#E0530A] disabled:opacity-50 text-white font-bold rounded-xl text-xs flex items-center gap-2 transition-all active:scale-[0.98] shadow-md shadow-[#FF6014]/15"
            >
              {isLoading ? (
                <>
