        ...
        {!submitted ? (
          <motion.form key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="subject" className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em]">Subject Topic <span className="text-[#FF6014]">*</span></label>
            ...
            <Button type="submit" disabled={isLoading} className="w-full bg-[#FF6014] hover:bg-[#e84e53] disabled:opacity-60 text-white text-xs font-extrabold py-3.5 h-auto rounded-xl border-none transition-colors shadow-sm flex items-center justify-center gap-2">
