  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section
          ref={heroRef}
          className="relative border-b border-slate-100 py-14 md:py-20 overflow-hidden"
        >
          ...
          <div className="max-w-3xl mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            >
              ...
              >
                Reach our team for booking support, service complaints,
                partnership requests, or any urgent household emergency — we
                respond fast.
              </motion.p>
            ...
            <RevealSection>
              <div className="grid md:grid-cols-3 gap-5">
                {CONTACT_CHANNELS.map(
                  (
                    { icon: Icon, label, primary, href, secondary, badge },
                    i,
                  ) => (
                    <motion.a
                      key={label}
                      ...
                      whileHover={{
                        y: -5,
                        boxShadow: "0 12px 32px rgba(255,90,95,0.10)",
                      }}
                      whileTap={{ scale: 0.98 }}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-start">
              ...
              <RevealSection className="lg:col-span-7">
                <motion.div className="bg-white border border-slate-100 rounded-[32px] p-7 md:p-10 shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
                  <div className="mb-7">
                    ...
                    {!submitted ? (
                      ...
                      >
                          ...
                          {[
                            ...
                            (
                              ...
                              <div key={id} className="space-y-1.5">
                                <label
                                  htmlFor={id}
                                  className="text-xs font-extrabold text-slate-600 uppercase tracking-wide"
                                >
                                  {label}{" "}
                                  {required && (
                                ...
                                <motion.input
                                  ...
                                  whileFocus={{
                                    scale: 1.005,
                                    boxShadow: "0 0 0 3px rgba(255,90,95,0.10)",
                                  }}
                                  className={
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                          ...
                          <div className="space-y-1.5">
                            ...
                            >
                              ...
                              <option value="Service Quality Complaint">
                                Service Quality Complaint
                              </option>
                              <option value="Refund Request">
                                Refund Request
                              </option>
                              <option value="Become a Partner">
                                Become a Partner
                              </option>
                        ...
                        <p className="text-center text-[11px] text-slate-400">
                          ...
                          <a
                            href="/privacy"
                            className="underline hover:text-[#FF5A5F]"
                          >
                            Privacy Policy
                          </a>
                          .
                ...
                <motion.div className="flex flex-col gap-5">
                  ...
                  >
                    ...
                    <div className="relative z-10 p-6 space-y-1">
                      ...
                      <p className="text-slate-300 text-xs font-medium">
                        Level 4, House 24, Road 12, Banani, Dhaka — Sat to Thu,
                        9 AM – 6 PM
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Stay updated with service launches, seasonal offers, and
                      home-care tips.
                    </p>
        ...
        {/* ══ FAQ ══════════════════════════════════════════════════ */}
        <section className="border-t border-slate-100 py-14 md:py-20">
                      ...
                      >
                        <span
                          className={`text-lg font-bold pr-4 transition-colors duration-200 ${
                            isOpen ? "text-[#FF5A5F]" : "text-slate-800"
                          }`}
                        >
                          {faq.question}
                        </span>
                        ...
                        >
                          <ChevronDown
                            className={`w-4 h-4 flex-shrink-0 transition-colors duration-200 ${
                              isOpen ? "text-[#FF5A5F]" : "text-slate-400"
                            }`}
                          />
                        </motion.div>
                      </button>
        ...
        {/* ══ CTA STRIP ════════════════════════════════════════════ */}
        <RevealSection className="max-w-7xl mx-auto px-4 md:px-6">
          <motion.section className="bg-linear-to-br from-primary/80 via-primary/50 to-primary/80 rounded-xl py-12 md:py-16 mb-12 md:mb-16 relative overflow-hidden">
            {/* Decorative circle */}
            <motion.div
            ...
            />
            <motion.div
              className="pointer-events-none absolute -left-10 -bottom-10 w-48 h-48 rounded-full bg-white/10"
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 text-center space-y-5 relative z-10">
              ...
              >
                Browse 20+ service categories and get matched with a verified
