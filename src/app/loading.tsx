...
export default function Loading(): React.JSX.Element {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 px-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] md:w-[450px] h-[250px] md:h-[450px] bg-[#FF5A5F]/8 blur-[80px] md:blur-[110px] rounded-full pointer-events-none z-0" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="w-full max-w-[200px] sm:max-w-[240px] md:max-w-[280px] aspect-square flex items-center justify-center">
          {animationData ? (
            ...
            <div className="relative w-16 h-16 flex items-center justify-center">
              <div className="absolute w-16 h-16 border-4 border-slate-200 border-t-[#FF5A5F] rounded-full animate-spin" />
              <div className="w-8 h-8 bg-[#FF5A5F]/10 rounded-full animate-ping" />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col items-center gap-1.5">
          <p className="text-[#FF5A5F] font-bold text-sm tracking-widest uppercase animate-pulse font-sans">
            Please Wait
          </p>
